...
typedef struct {
  ...
  int32_T BalancingTempGroup_b;        /* '<Root>/BalancingTempGroup' */
 ...
 *
 * hilite_system('BMS_Algo_Release_v10_11/CellBalancing')    - opens subsystem BMS_Algo_Release_v10_11/CellBalancing
 * hilite_system('BMS_Algo_Release_v10_11/CellBalancing/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'BMS_Algo_Release_v10_11'
 * '<S1>'   : 'BMS_Algo_Release_v10_11/CellBalancing'
 * '<S2>'   : 'BMS_Algo_Release_v10_11/CellBalancing/BalancingStateMachine'
 * '<S3>'   : 'BMS_Algo_Release_v10_11/CellBalancing/InputProcessing'
 * '<S4>'   : 'BMS_Algo_Release_v10_11/CellBalancing/WriteMosfetsData'
 * '<S5>'   : 'BMS_Algo_Release_v10_11/CellBalancing/InputProcessing/Chart'
 * '<S6>'   : 'BMS_Algo_Release_v10_11/CellBalancing/InputProcessing/Chart1'
 * '<S7>'   : 'BMS_Algo_Release_v10_11/CellBalancing/InputProcessing/Chart2'
 * '<S8>'   : 'BMS_Algo_Release_v10_11/CellBalancing/InputProcessing/Compare To Constant'
 */
