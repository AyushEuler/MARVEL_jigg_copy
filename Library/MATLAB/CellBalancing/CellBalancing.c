...
void CellBalancing_step(void)
{
  ...
  if (CellBalancing_DW.is_active_c6_CellBalancing == 0U) {
    ...
    if (CellBalancing_U.DataPipeline.TemperatureSenseBus[CellBalancing_U.BalancingTempGroup_b
        - 1].T_max <=
    ...
    if (CellBalancing_DW.durationCounter_1 * 100 >
      ...
      CellBalancing_DW.x =
        CellBalancing_U.DataPipeline.TemperatureSenseBus[CellBalancing_U.BalancingTempGroup_b
        - 1].T_max;
    }
  }
