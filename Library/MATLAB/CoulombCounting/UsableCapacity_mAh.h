...
/* Block signals for system '<S18>/UsableCapacity_mAh' */
typedef struct {
  int32_T MaxUsableCapacity_mAh;       /* '<S18>/UsableCapacity_mAh' */
} B_UsableCapacity_mAh_SOCEst_l_T;

extern void SOCEstimatio_UsableCapacity_mAh(real32_T rtu_CycleCount, int32_T
...
extern void SOCEstimat_UsableCapacity_mAh_m(real32_T rtu_CycleCount, int32_T
