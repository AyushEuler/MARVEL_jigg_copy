...
#ifndef DEFINED_TYPEDEF_FOR_SlowChargingSoC_
#define DEFINED_TYPEDEF_FOR_SlowChargingSoC_
...
#ifndef DEFINED_TYPEDEF_FOR_FastChargingSoC_
#define DEFINED_TYPEDEF_FOR_FastChargingSoC_
...
typedef struct {
  ...
  int32_T MinCurrentLimit_mA;
  int32_T MaxAllowedImb_mV;
  SlowChargingSoC SlowChargingSoC;
  FastChargingSoC FastChargingSoC;
} CC_InputsBus;
...
typedef struct {
  boolean_T SlowChargingSoC;
  boolean_T FastChargingSoC;
  ...
  uint32_T SlowChargingSoCrsCurrentLimit_A;
  uint32_T FastChargingSoCrsCurrentLimit_A;
} VCU;
