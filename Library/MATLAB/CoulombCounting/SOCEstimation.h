...
typedef struct {
  ProtectionOutput ProtectionOutput_b; /* '<Root>/ProtectionOutput' */
 ...
 *
 * hilite_system('BMS_Algo_Release_v10_12/SOCEstimation')    - opens subsystem BMS_Algo_Release_v10_12/SOCEstimation
 * hilite_system('BMS_Algo_Release_v10_12/SOCEstimation/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'BMS_Algo_Release_v10_12'
 * '<S1>'   : 'BMS_Algo_Release_v10_12/SOCEstimation'
 * '<S2>'   : 'BMS_Algo_Release_v10_12/SOCEstimation/Chart'
 * '<S3>'   : 'BMS_Algo_Release_v10_12/SOCEstimation/CoulombCounter'
 * '<S4>'   : 'BMS_Algo_Release_v10_12/SOCEstimation/SOC_Calibration'
 * '<S5>'   : 'BMS_Algo_Release_v10_12/SOCEstimation/SOC_ReadFromFlash'
 * '<S6>'   : 'BMS_Algo_Release_v10_12/SOCEstimation/SOC_WriteToFlash'
 * '<S7>'   : 'BMS_Algo_Release_v10_12/SOCEstimation/SOH_Calculation'
 * '<S8>'   : 'BMS_Algo_Release_v10_12/SOCEstimation/SOH_Calibration'
 * '<S9>'   : 'BMS_Algo_Release_v10_12/SOCEstimation/Subsystem'
 * '<S10>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/Voltage_Vs_Capacity'
 * '<S11>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/powergui'
 * '<S12>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/CoulombCounter/Chart'
 * '<S13>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/CoulombCounter/Chart1'
 * '<S14>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/SOC_Calibration/SOC_Calibration'
 * '<S15>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/SOH_Calculation/Chart'
 * '<S16>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/SOH_Calculation/UsableCapacity_mAh'
 * '<S17>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/SOH_Calibration/SOH_Calibration'
 * '<S18>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/SOH_Calibration/Subsystem'
 * '<S19>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/SOH_Calibration/Subsystem/Chart'
 * '<S20>'  : 'BMS_Algo_Release_v10_12/SOCEstimation/SOH_Calibration/Subsystem/UsableCapacity_mAh'
 */
