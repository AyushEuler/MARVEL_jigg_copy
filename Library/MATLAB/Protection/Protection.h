 ...
 * C source code generated on : Thu Jan 11 18:45:14 2024
 *
 ...
 *
 * hilite_system('BMS_Algo_Release_v10_11/Protection')    - opens subsystem BMS_Algo_Release_v10_11/Protection
 * hilite_system('BMS_Algo_Release_v10_11/Protection/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'BMS_Algo_Release_v10_11'
 * '<S1>'   : 'BMS_Algo_Release_v10_11/Protection'
 * '<S2>'   : 'BMS_Algo_Release_v10_11/Protection/CurrentVoltageTemperature_Statemachine'
 * '<S3>'   : 'BMS_Algo_Release_v10_11/Protection/Discrete Derivative'
 * '<S4>'   : 'BMS_Algo_Release_v10_11/Protection/Discrete Derivative1'
 */
