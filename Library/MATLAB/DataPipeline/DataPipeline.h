 ...
 *
 * hilite_system('BMS_Algo_Release_v10_11/DataPipeline')    - opens subsystem BMS_Algo_Release_v10_11/DataPipeline
 * hilite_system('BMS_Algo_Release_v10_11/DataPipeline/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'BMS_Algo_Release_v10_11'
 * '<S1>'   : 'BMS_Algo_Release_v10_11/DataPipeline'
 * '<S2>'   : 'BMS_Algo_Release_v10_11/DataPipeline/AverageFunction'
 * '<S3>'   : 'BMS_Algo_Release_v10_11/DataPipeline/DynamicCurrentLimits_perParallelCell'
 * '<S4>'   : 'BMS_Algo_Release_v10_11/DataPipeline/I2t_perParallelCell'
 * '<S5>'   : 'BMS_Algo_Release_v10_11/DataPipeline/MaximumFunction'
 * '<S6>'   : 'BMS_Algo_Release_v10_11/DataPipeline/MinimumFunction'
 */
