...
#define LOOP_DELAY_30MS                      30
#define LOOP_DELAY_250MS                     250
#define LOOP_DELAY_1000MS                    1000
#define LOOP_DELAY_CMU_DATA_COLLECTION       LOOP_DELAY_30MS
#define LOOP_DELAY_CONTACTOR_CONTROL         LOOP_DELAY_30MS
#define LOOP_DELAY_PROTECTION                LOOP_DELAY_30MS
#define LOOP_DELAY_STATE_MACHINE             LOOP_DELAY_30MS
#define LOOP_DELAY_FIRMWARE_UPGRADE          LOOP_DELAY_30MS
#define LOOP_COULOMB_COUNTING                LOOP_DELAY_30MS
#define TIME_SCALER                          2.6
